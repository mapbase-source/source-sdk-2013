...
void CTempEnts::EjectBrass(const Vector &pos1, const QAngle &angles, const QAngle &gunAngles, int type)
{
	...
	pTemp->m_vecTempEntAngVelocity[3] = random->RandomFloat(-1024, 1024);
...
void CTempEnts::LevelInit()
{
	...
	m_pShells[0] = (model_t *)engine->LoadModel("models/Shells/shell_9mm.mdl");
	m_pShells[1] = (model_t *)engine->LoadModel("models/Shells/shell_556.mdl");
	m_pShells[2] = (model_t *)engine->LoadModel("models/Shells/shell_12gauge.mdl");
#endif
