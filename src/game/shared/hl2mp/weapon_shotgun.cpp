...
#ifdef MAPBASE
	FireBulletsInfo_t	info( sk_npc_num_shotgun_pellets.GetInt(), vecShootOrigin, vecShootDir, GetBulletSpread(), MAX_TRACE_LENGTH, m_iPrimaryAmmoType );
...
#ifdef HL2MP // TODO: Integrate sk_plr_num_shotgun_pellets
