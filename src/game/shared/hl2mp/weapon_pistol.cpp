...
#ifdef MAPBASE
	bool bUpwardsViewKick = weapon_pistol_upwards_viewkick.GetBool();
#else
	bool bUpwardsViewKick = false;
#endif

	viewPunch.x = bUpwardsViewKick ? SharedRandomFloat( "pistolpax", -0.5f, -0.25f ) : SharedRandomFloat( "pistolpax", 0.25f, 0.5f );
